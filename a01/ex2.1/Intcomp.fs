...
let e1_1 = Let("z", CstI 17, Prim("+", Var "z", Var "z"));;

let e2_1 = Let("z", CstI 17,
             Prim("+", Let("z", CstI 22, Prim("*", CstI 100, Var "z")),
                       Var "z"));;

let e3_1 = Let("z", Prim("-", CstI 5, CstI 4),
             Prim("*", CstI 100, Var "z"));;

let e4_1 = Prim("+", Prim("+", CstI 20, Let("z", CstI 17,
                                          Prim("+", Var "z", CstI 2))),
                   CstI 30);;

let e5_1 = Prim("*", CstI 2, Let("x", CstI 3, Prim("+", Var "x", CstI 4)));;

let e6_1 = Let("z", Var "x", Prim("+", Var "z", Var "x"))
let e7_1 = Let("z", CstI 3, Let("y", Prim("+", Var "z", CstI 1), Prim("+", Var "z", Var "y")))
let e8_1 = Let("z", Let("x", CstI 4, Prim("+", Var "x", CstI 5)), Prim("*", Var "z", CstI 2))
let e9_1 = Let("z", CstI 3, Let("y", Prim("+", Var "z", CstI 1), Prim("+", Var "x", Var "y")))
let e10_1 = Let("z", Prim("+", Let("x", CstI 4, Prim("+", Var "x", CstI 5)), Var "x"), Prim("*", Var "z", CstI 2))
...
let run e = eval e [];;
let res = List.map run [e1_1;e2_1;e3_1;e4_1;e5_1;e7_1]  (* e6_1 has free variables *)
...
let _ = List.map closed1 [e1_1;e2_1;e3_1;e4_1;e5_1;e6_1;e7_1;e8_1;e9_1;e10_1]
...
let _ = List.map closed2 [e1_1;e2_1;e3_1;e4_1;e5_1;e6_1;e7_1;e8_1;e9_1;e10_1]
